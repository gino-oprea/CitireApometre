		...
		try {
			...
			if (sd.canWrite())
			{
				String backupDBPath  = "/" + context.getResources().getString(R.string.CitireApometre) +
						"/Apometre.db";
				File  backupDB= context.getDatabasePath("Apometre.db");//new File(data, currentDBPath);
	...
	public static void exportDB(Context context)
	{
		...
		try {
			...
			if (sd.canWrite()) {
				...
				String backupDBPath  = "/" + context.getResources().getString(R.string.CitireApometre) +
						"/Apometre.db";
				File currentDB = context.getDatabasePath("Apometre.db");//new File(data, currentDBPath);
